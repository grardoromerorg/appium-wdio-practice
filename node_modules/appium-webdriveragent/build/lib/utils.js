...
exports.isTvOS = exports.killAppUsingPattern = exports.getPIDsListeningOnPort = exports.resetTestProcesses = exports.getWDAUpgradeTimestamp = exports.randomInt = exports.killProcess = exports.getXctestrunFilePath = exports.setXctestrunFile = exports.generateXcodeConfigFile = exports.getXctestrunFileName = exports.getAdditionalRunContent = exports.setRealDeviceSecurity = exports.resetProjectFile = exports.updateProjectFile = exports.BOOTSTRAP_PATH = void 0;
...
async function generateXcodeConfigFile(orgId, signingId) {
    logger_1.default.debug(`Generating xcode config file for orgId '${orgId}' and signingId ` +
        `'${signingId}'`);
    const contents = `DEVELOPMENT_TEAM = ${orgId}
CODE_SIGN_IDENTITY = ${signingId}
`;
    const xcconfigPath = await support_1.tempDir.path('appium-temp.xcconfig');
    logger_1.default.debug(`Writing xcode config file to ${xcconfigPath}`);
    await support_1.fs.writeFile(xcconfigPath, contents, 'utf8');
    return xcconfigPath;
}
