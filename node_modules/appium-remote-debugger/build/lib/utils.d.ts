...
export function getDebuggerAppKey(bundleId: any, appDict: any): string | undefined;
export function getPossibleDebuggerAppKeys(bundleIds: any, appDict: any): string[];
